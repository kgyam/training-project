package org.example.user.web.orm;
...
public class DelegatingEntityManager implements EntityManager, DisposableComponent, ComponentFactoryAware {
    ...
    private Map loadProperties(String propertiesLocation) {
        ...
        try {
            properties.load(classLoader.getResource(propertiesLocation).openStream());
        } catch (IOException e) {
        ...
        properties.stringPropertyNames().forEach(key -> {
            ...
            if (value.startsWith("@")) {
                ...
                Object component = componentFactory.getComponent(componentName);
                if (component != null) {
                    properties.put(key, component);
                }
            }
        });
        return properties;
