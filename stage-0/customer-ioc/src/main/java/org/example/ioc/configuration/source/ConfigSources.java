...
public class ConfigSources implements Iterable<ConfigSource> {
    ...
    public void addDefaultSources() {
        ...
        addConfigSource (JavaSystemConfigSource.class, SystemConfigSource.class
    ...
    public void addDiscoveredSources() {
        ...
        addConfigSource (ServiceLoader.load (ConfigSource.class, this.classLoader));
     ...
     */
    public void addConfigSource(Class<? extends ConfigSource>... configSourceClass) {
        addConfigSource (Stream.of (configSourceClass).map (this::newInstance).toArray (ConfigSource[]::new));
    }
     ...
     */
    public void addConfigSource(ConfigSource... configSourceArr) {
        addConfigSource (Arrays.asList (configSourceArr));
    }

    /**
     * @param configSourceIterable
     */
    public void addConfigSource(Iterable<ConfigSource> configSourceIterable) {
